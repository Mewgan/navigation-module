            ...
            <div class="card panel">
                <div class="card-head card-head-sm collapsed">
                    ...
                    <div class="tools">
                        ...
                        <a v-show="auth.status.level < 4" class="btn btn-default-bright" data-toggle="collapse"
                           :data-parent="accordion_parent"
                           :data-target="'#item-accordion-' + item.id"
                           aria-expanded="false"><i
                                class="fa fa-pencil"></i></a>
                        <a data-toggle="modal" title="Supprimer la rubrique" :data-target="'#deleteNavBarModal' + item.id" class="btn delete-item btn-default-bright"><i
